...
import com.domain.entities.enums.EnumDateFormat;
...
public class DateUtil {
    ...
    public static final DateTimeFormatter ISO8601 = EnumDateFormat.ISO8601.getFormat();

    public static final DateTimeFormatter ISO8601Z = EnumDateFormat.ISO8601Z.getFormat();

    public static final DateTimeFormatter YYYYMMDDTHHMMSS = EnumDateFormat.YYYYMMDDTHHMMSS.getFormat();

    public static final DateTimeFormatter HHMMSS = EnumDateFormat.HHMMSS.getFormat();
    ...
    public static String formatHHMMSSS(LocalDateTime date) {
    ...
    public static LocalDateTime YYYYMMDDTHHMMZToLocalDateTime(String value) {
        return LocalDateTime.from(YYYYMMDDTHHMMZ.parse(value));
    }

    public static LocalDateTime ISO8601ToLocalDateTime(String value) {
        return LocalDateTime.from(ISO8601.parse(value));
    }

    public static LocalDateTime YYYYMMDDTHHMMSSToLocalDateTime(String value) {
        return LocalDateTime.from(YYYYMMDDTHHMMSS.parse(value));
    }

    public static LocalDateTime ISO8601ZToLocalDateTime(String value) {
        return LocalDateTime.from(ISO8601Z.parse(value));
    }
